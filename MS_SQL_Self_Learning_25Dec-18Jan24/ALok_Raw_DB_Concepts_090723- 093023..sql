Create database DB_090723_ALok_Concepts
use DB_090723_ALok_Concepts
...
update tblEmployee set name ='Fahad', age= 50 where empid=4

UPDATE tblEMployee set name='Ali', age=30, city = 'Jaunpur' where empid=4
